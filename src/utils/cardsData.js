export const cardsData = {
  airplane: [
    { id: 1, text: "✈️ airplane flying in blue sky" },
    { id: 2, text: "✈️ airplane taking off from runway" },
    { id: 3, text: "✈️ airplane landing at airport" },
    { id: 4, text: "✈️ airplane parked at gate" },
    { id: 5, text: "✈️ airplane flying above clouds" },
    { id: 6, text: "✈️ airplane at sunset" },
    { id: 7, text: "✈️ airplane with landing gear down" },
    { id: 8, text: "✈️ airplane flying over mountains" },
    { id: 9, text: "✈️ airplane in stormy weather" },
    { id: 10, text: "✈️ airplane at night with lights" }
  ],
  helicopter: [
